...
namespace GameZone.Application.IntegrationTests.QueryHandlers
{
    public class GetGameByIdQueryHandlerTests
    {
        ...
        public GetGameByIdQueryHandlerTests()
        {
            ...
            var game = new GameZoneModels.Game { Id = _gameId, Name = "game 1" };
        ...
        [Fact]
        public async Task GetGameById_WhenInvalidId_ThrowsException()
        {
            // arrange
            ...
            await Assert.ThrowsAsync<KeyNotFoundException>(async () 
                => await handler.Handle(query, cancellationToken: default));
        }
